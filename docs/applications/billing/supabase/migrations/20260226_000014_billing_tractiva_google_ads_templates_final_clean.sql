-- Final clean reset for Tractiva Google Ads templates (company + person)
-- This migration deletes previous Google Ads Tractiva templates and recreates two clean active templates.
...
delete from billing.contract_templates t
using tractiva s
where t.service_id = s.id
  and t.name ilike '%Google Ads Tractiva.cl%';
...
<html lang="es">
  <head>
    ...
    <style>
      ...
      .sig-watermark { position: absolute; left: 50%; top: 52%; transform: translate(-50%, -50%); pointer-events: none; z-index: 4; }
      .sig-watermark img { width: 288px; max-width: 288px; height: auto; opacity: 0.10; filter: grayscale(100%); }
  ...
  <body>
    <main class="wrap">
      ...
      <h2>14. Firma</h2>
      <p>En señal de aceptación del presente acuerdo digital, las partes dejan constancia electrónica de su conformidad.</p>
  ...
  '{
    ...
    "plan_name": "string",
    "monthly_amount_clp": "string",
    "kumera_signed_date": "string",
