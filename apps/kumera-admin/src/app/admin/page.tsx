  ...
  return (
    <section className="rounded-xl border border-slate-800 bg-slate-900 p-5">
      ...
      <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-3">
        <Link className="rounded-lg border border-slate-700 bg-slate-800 px-4 py-3 text-sm font-semibold text-slate-100 transition hover:bg-slate-700" href="/admin/roles">
          Roles globales (core)
        </Link>
